...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="" id="dropdown05" aria-expanded="false">Categorias</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown05">
                            <?php foreach ($data['categorias'] as $categoria) {
                                echo '<li><a class="dropdown-item" href="' . $url_alias . '/categorias/get/' . $categoria['id'] . '">' . $categoria['nome'] . '</a></li>';
                            } ?>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="col-8">
                <h1 class="text-center m-4 col-10">Categorias</h1>
            </div>
        ...
        <table class="table table-striped align-middle">
            ...
            <tbody>
                ...
                foreach ($data['categorias'] as $categoria) {
                    ...
                    echo '<td class="align-middle"><button type="button" class="btn btn-primary btn-outline-light" href="' . $url_alias . 'categoria/' . $categoria['id'] . '">Editar Categoria</button></td>';
                    echo '<td class="align-middle"><a class="btn btn-danger btn-outline-light" onclick="return confirm(\'Tem certeza que deseja deletar este User?\')"  role="button">Eliminar</a></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
