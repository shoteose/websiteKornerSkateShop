        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample03">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="" id="dropdown05" aria-expanded="false">Contas</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown05">
                            <?php foreach ($data['contas'] as $conta) {
                                echo '<li><a class="dropdown-item" href="' . $url_alias . '/contas/get/' . $conta['id'] . '">' . $conta['nome'] . '</a></li>';
                            } ?>
                        </ul>
                    </li>
                    <li class="nav-item">
        ...
        <table class="table table-striped align-middle">
            ...
            <tbody>
                ...
                foreach ($data['contas'] as $conta) {
                    ...
                    echo '<td class="align-middle"><button type="button" class="btn btn-primary btn-outline-light" href="' . $url_alias . 'conta/' . $conta['id'] . '">Editar Conta</button></td>';
